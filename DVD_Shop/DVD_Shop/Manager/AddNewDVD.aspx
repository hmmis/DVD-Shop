<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddNewDVD.aspx.cs" Inherits="DVD_Shop.Manager.AddNewDVD" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <br />
        <asp:Label ID="Label1" runat="server" BorderStyle="Dotted" Text="Add New DVD"></asp:Label>
        <br />
        <br />
        ...
        <br />
        <br />
        <asp:Button ID="ButtonAddMovie" runat="server" onclick="ButtonAddMovie_Click" 
            Text="Add Movie" />
